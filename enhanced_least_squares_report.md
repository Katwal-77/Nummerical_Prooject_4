...
$$\text{Temperature} = -5.84 + 8.76x - 1.53x^2 + 0.09x^3 - 0.002x^4$$
...
For predictions, the confidence interval widens as we move away from the mean of the data, reflecting increased uncertainty:
